...
class MeeshoPinDataFinalSpider(scrapy.Spider):
    ...
    def __init__(self, name: Optional[str] = None, pincode: str = "560001",
                 dbname=str(datetime.now().strftime("%Y%m%d")), start=0, end=100000, **kwargs: Any):
    ...
    def parse(self, response,**kwargs):
        ...
        pincode_file_path = open(f"{self.pincode_folder_location}/{name_list[0]}_{name_list[1]}.json")
...
if __name__ == '__main__':
    pass
    execute("scrapy crawl meesho_pin_data_final -a pincode=560001 -a start=4430 -a end=4430".split())
